...
\item\textsc{\textbf{L.~You}, J.~Li, C.~Wei, L.~Hu}, ``MPAR: A Movement Pattern-Aware Optimal Routing for Social Delay Tolerant Networks,'' in \textit{Elsevier Ad Hoc Networks Journal} (\textbf{SCI}, Impact Factor \textbf{1.943}), in press.
